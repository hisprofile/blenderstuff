...
# Rigi-All
## Introduction
Rigi-All is a suite of tools dedicated to the building of a quick & easy Rigify rig from an existing model and rig. From game assets, for example. Every model deserves a great rig that animators deserve to use.
